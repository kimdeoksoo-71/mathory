...
## 현재 Phase: **개선묶음 M8 — 모바일 웹 디자인·기능 개선** — 구현·**덕수 검수 종결(2026-09-12, "모두 정상")** · **배포 완료(2026-09-12)** — 배포본 검수 정상
...
- **사이드바(D22·D23′)**: `SidebarSectionHeader` 공용(My **IconUserCircleBold**(검수 5차 — 폴더 행과 겹치던 folder 대체) · 공유 IconShareBold · 최근 IconRecentBold — 검수 6차부터 **bold 16 · 글자 13.5/700**, 래퍼 `'8px 12px'`) ·
