...
ICONS 56 → **58종**(+6/−4, toggle 2종은 후속 철회 · user-circle 5차 추가) · 자산 3,024 → **1,512개**(regular 단일) · 커밋 S1~S12 + 검수 후속 4(1차 6건 · 2차 카드 그림자 · 3차 색 팔레트 전수 정리 · 4차 체크박스·파비콘) · 로직 검증 371 → **373건**.
...
- **사이드바(D22·D23′)**: `SidebarSectionHeader` 공용(My **IconUserCircle**(검수 5차 — 폴더 행과 겹치던 folder 대체) · 공유 IconShare · 최근 IconRecent 16, 12.5/600, 래퍼 `'8px 12px'`) ·
