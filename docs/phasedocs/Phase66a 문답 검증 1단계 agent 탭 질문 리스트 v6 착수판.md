...
- **66b 계획 v1 검증 턴** — `docs/phaseSketch/phase66b-problem-questions-plan-v1.md`(질문 카테고리 [문제]·[풀이] · 문제 검증 질문 P1~P4).
  ⚠ 이 문서 §12의 "66b = 폴더뷰 순차 실행 · 66c = 칩 정리"는 그 계획의 **Q8**에 따라 66c·66d로 밀릴 수 있다
