...
**남은 확인(덕수)**: ① 하위경우 접힘 dot의 구멍이 글꼴 11px에서 보이는지(안 보이면 0.34em 복귀 또는 `max(0.3em, 4.5px)` 하한) ② 하위경우 display 수식 9em(35em 칼럼의 26%)에서 긴 수식이 넘치지 않는지 ③ 흑백 인쇄에서 rail(#8a8a8a)·dot(#000) 농도.
