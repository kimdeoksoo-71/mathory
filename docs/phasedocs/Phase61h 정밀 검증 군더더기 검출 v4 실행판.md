...
계보: v1(web, 2026-09-09) → v2(web, 덕수 결정 반영·착수판) → v3(CLI 실측 교차검토 — 정정 E1~E9 · 보완 G1~G10 · 결정 N1~N5) → **v4 = 실행판** (N1~N5 전부 권장안으로 덕수 확정 2026-09-10 · §11이 구현·프로브 기록). 중간 판본 v1~v3는 **2026-09-11 문서 정리에서 삭제**했다(git 이력에 남아 있다) — 정정 E1~E9·보완 G1~G10·결정 N1~N5가 전부 이 판에 흡수돼 있다.
