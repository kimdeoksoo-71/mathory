...
**남은 것**: 실험 §10 재개 · 실물 검수 11항 · **66b 계획 v1 검증**(`docs/phaseSketch/phase66b-problem-questions-plan-v1.md` —
질문 카테고리 [문제]·[풀이] · 문제 검증 질문 P1~P4). ⚠ 옛 예약 "66b = 폴더뷰 순차 실행 · 66c = 칩 정리"는 그 계획의 Q8에 따라
66c·66d로 밀릴 수 있다. 배치 시간 추정은 **문항 × 질문 × 도구 턴 최대 4회**다.
