...
## Phase 59: 요약 보기(structure at a glance) · '경우' 블록 🔨 구현 완료 / 검증 대기

착수 문서: `docs/phasedocs/Phase59 요약 보기·경우 블록.md` (v1 web → v2 CLI → v3 web → v4 CLI 착수본)
...
| 요약에 넣기 | 블록 상단바의 라디오(`showInSummary`)로 고른 블록만 요약에 남는다(그림·표·글상자 무관) — 스켈레톤 원칙의 유일한 예외 |
