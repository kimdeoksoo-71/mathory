...
/* M6 검수 6차의 헤더 전용 bold 3종(IconUserCircleBold·IconShareBold·IconRecentBold)은 M7 K(덕수 2026-09-12)에서
   삭제됐다 — 헤더는 regular 16 + 톤(--text-primary)으로 위계를 나른다. "regular 단일" 규약에 예외 0. */
